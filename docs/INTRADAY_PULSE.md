...
| `--no-history` (`--no-prev`) | false | 이전 적립/누적 레코드 무시 (독립 실행 및 디버깅용) |
...
📈 지수 (전일대비 · 최근1h/2h)
  KOSPI   8,565.06  ▼-6.03%   1h ▼-1.8%  2h ▼-3.1%   거래대금 36.6조
          시 9,083 / 고 9,175 / 저 8,511   상승 87 · 보합 25 · 하락 823 (하한 2) · 총 935 (상승비율 9.3%)
  KOSDAQ    907.47  ▼-6.29%   1h ▼-2.0%  2h ▼-3.4%   상승 148 (상한 3) · 보합 40 · 하락 1,561 · 총 1749 (상승비율 8.6%)

💰 수급 — 최근 1h 델타 (괄호=당일 누적)
  KOSPI   외국인 ▼-12000억 가속 (누적 -35600억) · 기관 ▼-4000억 (-15400억) · 개인 ▲+15500억 (+51000억) · 기타법인 ▼-68억 (합계 0억)
  └ 기관 세부(누적): 금융투자 -9967억 · 보험 -596억 · 투신 -1286억 · 기타금융 -39억 · 은행 -146억 · 연기금 -1290억 · 사모 -2081억 (합계 -15400억)
  KOSDAQ  외국인 ▼-300억 (-18억) · 기관 ▲+150억 (+1142억) · 개인 ▼-... · 기타법인 ... (합계 0억)
  └ 기관 세부(누적): 금융투자 ... · 보험 ... · 투신 ... · 기타금융 ... · 은행 ... · 연기금 ... · 사모 ... (합계 +1142억)

🌡️ 국내 파생·변동성
  KOSPI200 선물 A01609  1062.70 (-0.50%) · 현물 1061.34 · 단순스프레드(raw_spread) +1.36p (콘탱고)

💱 환율
  원/달러(Yahoo 역외스팟)   1,534.4300  전일 ▼-0.12% (기준 1,536.20원)   1h +0.02%  2h -0.11%  @13:38
